...
\hypersetup{
  pdftitle={Appendix B - Generalized Linear Model and Cluster Analysis of possible influence factors of Public Transport subscriptions in Switzerland},
...
All estimates can be plotted against each other to recognize
